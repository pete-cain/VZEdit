...
for (var i = 1; i < 5; i++) {
  ...
  if (i < 4) {
    ...
    document.getElementById('line' + i).innerHTML +=
      "<input type='submit' value='' class='line'  id='extPhase" + i + "' >";
  }
...
for (var i = 1; i < 9; i++) {
  ...
  document.getElementById('modulation_M' + i).innerHTML = buildModuleModulation(
    i
  );
}
...
function buildModuleModulation(module) {
  ...
  moduleModulationString +=
    "<canvas id='keyFollow" +
    module +
    "' width = '150px' height='40px' onclick = 'activateKFModule(" +
    module +
    ")'></canvas><br>";
